export default function Footer() {
  return (
    <footer className="border-t border-rule dark:border-rule-dark py-6 px-6">
      <div className="max-w-site mx-auto flex flex-col items-center text-center space-y-1">
        <span className="font-mono text-xs text-ink-faint dark:text-ink-faint-dark">Designed &amp; built by</span>

        <a
          href="https://amithasannurnabi.com/"
          target="_blank"
          rel="noopener noreferrer"
          className="group relative inline-block font-sans font-medium text-base md:text-lg text-ink dark:text-ink-dark transition-colors hover:text-accent-red"
        >
          Amit Hasan NurNabi
